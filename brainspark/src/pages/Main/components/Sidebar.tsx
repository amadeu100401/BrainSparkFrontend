...
export default function Sidebar() {
  ...
  return (
    <div className="relative flex h-screen overflow-hidden">
      ...
      <div
        className={`fixed top-0 left-0 w-full h-full bg-black z-30 transition-opacity duration-300 pointer-events-none ${
          isCollapsed ? 'opacity-0' : 'opacity-40 pointer-events-auto'
        }`}
